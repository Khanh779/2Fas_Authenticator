    ...
    internal class TOTP_Auth
    {
        ...
        public static string GenerateTotp(string secretKey)
        {
            ...
            using (var hmac = new HMACSHA1(key))
            {
                ...
                // Trả về mã TOTP
                return (binaryCode % (int)Math.Pow(10, Digits)).ToString().PadLeft(Digits, '0');
            }
        }
